					...
					<c:when test="${!empty tSubList}">
						<div class="classCardWrap">
							<c:forEach items="${tSubList }" var="subjectVo">
								<c:choose>
									<c:when test="${subjectVo.keep_yn == 'N' }">
										<c:set var="nCnt" value="${nCnt+1}" />
									</c:when>
								</c:choose>

								<c:if test="${subjectVo.keep_yn!= 'Y' }">
									...
									<div class="classCard" data-sucode="${subjectVo.su_code}">
										<div class="cardTop codeTransColor_back" data-sucode="${subjectVo.su_code}">
											<div class="titleWrap">
												...
												<div class="moreBtnWrap">
													...
													<div class="moreWrap">
														<a href="../main/keepOn.do?su_code=${subjectVo.su_code }" class="moreAnchor saveClass" data-class="">보관</a>
													</div>
												</div>
										...
										<div class="classCode toolTipWrap codeTransColor_back" data-sucode="${subjectVo.su_code}">
											<div>
												<input type="text" class="code" value="${subjectVo.su_code}">
												<span>${subjectVo.su_code}</span>
							...
							<!--전부 보관되어있음-->
							<c:if test="${empty nCnt and empty yCnt}"> 
			...
			<div class="modalCon">
				...
				<form action="/subject/subject.do" method="post">
					<c:forEach items="${tList}" var="teacherVo">
						...
						<input type="hidden" name="tname" value="${teacherVo.user_name}">
